...
namespace VHBurguer.Repositories
{
    public class PromocaoRepository : IPromocaoRepository
    {
        ...
        {
            Promocao promocao = _context.Promocao.FirstOrDefault(promocaoAux => promocaoAux.PromocaoID == id);
        ...
        public bool NomeExiste(string nome, int? promocaoIdAtual = null)
        {
            ...
            {
                consulta = consulta.Where(promocaoAux => promocaoAux.PromocaoID != promocaoIdAtual.Value);
            }

            return consulta.Any(promocaoAux => promocaoAux.Nome == nome);
        }
        ...
        {
            Promocao? promocaoBanco = _context.Promocao.FirstOrDefault(promocaoAux => promocaoAux.PromocaoID == promocao.PromocaoID);
